		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Agregacao",
									"targetURL": "#treinaui5agregacao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"treinaui5agregacao-display": {
								"semanticObject": "treinaui5agregacao",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=treinaui5.agregacao",
									"url": sap.ui.require.toUrl("treinaui5/agregacao")
								}
							}
						}
					}
